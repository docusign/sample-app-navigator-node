...
const TwiceChevronLeftIcon = ({ color = "#000000", size = 24, className = "" }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 12 8" fill="none" className={className}>
...
export default TwiceChevronLeftIcon;
