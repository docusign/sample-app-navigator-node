export const translationKeys = {
  ...
  AGREEMENT_DETAILS_AGREEMENT_CONTRACT_VALUE:
    "AGREEMENT_DETAILS_AGREEMENT_CONTRACT_VALUE",
  AGREEMENT_DETAILS_AGREEMENT_EFFECTIVE_DATE:
    "AGREEMENT_DETAILS_AGREEMENT_EFFECTIVE_DATE",
  AGREEMENT_DETAILS_AGREEMENT_EXPIRATION_DATE:
    "AGREEMENT_DETAILS_AGREEMENT_EXPIRATION_DATE",
  AGREEMENT_DETAILS_RENEWAL: "AGREEMENT_DETAILS_RENEWAL",
  AGREEMENT_DETAILS_RENEWAL_TYPE: "AGREEMENT_DETAILS_RENEWAL_TYPE",
  AGREEMENT_DETAILS_RENEWAL_NOTICE_PERIOD:
    "AGREEMENT_DETAILS_RENEWAL_NOTICE_PERIOD",
  AGREEMENT_DETAILS_RENEWAL_NOTICE_DATE:
    "AGREEMENT_DETAILS_RENEWAL_NOTICE_DATE",
  ...
  AGREEMENT_DETAILS_RENEWAL_ADDITIONAL_INFO:
    "AGREEMENT_DETAILS_RENEWAL_ADDITIONAL_INFO",
